...
/*  Keil::Device:STM32Cube HAL:DMA2D:1.7.6 */
...
/*  Keil::Device:STM32Cube HAL:LTDC:1.7.6 */
...
/*  Segger.MDK-Plus::Graphics:Input Device:Touchscreen:5.50.0 */
